    ...
    keys = {
      {
        ...
        mode = "v",
        {
          ...
          silent = true,
          expr = false,
          desc = "Extract a function from a visual selection.",
        },
      },
      {
        "<leader>rf",
        ...
        mode = "v",
        {
          ...
          silent = true,
          expr = false,
          desc = "Extract a function to an external file. (The function shuld be sleected in visual mode.)",
        },
      },
      {
        "<leader>rv",
        ...
        mode = "v",
        {
          ...
          silent = true,
          expr = false,
          desc = "Extract a variable that is selected in visual mode.",
        },
      },
      {
        "<leader>ri",
        ...
        mode = "v",
        {
          ...
          silent = true,
          expr = false,
          mode = "Inline a variable, that is selected in visual mode.",
        },
      },
      {
        "<leader>rb",
      ...
      },
      {
        ...
        "<Esc><Cmd>lua require('refactoring').refactor('Extract Block To File')<CR>",
        {
          ...
          silent = true,
          expr = false,
          desc = "Extract a block to another file.",
        },
      },
      {
        "<leader>ri",
